...
pub fn init() !void {
    ...
    for (&sounds, 0..) |*sound, i| {
        ...
        res = miniaudio.ma_sound_init_from_data_source(&engine, @as(*miniaudio.ma_data_source, @ptrCast(&sound.decoder)), miniaudio.MA_SOUND_FLAG_DECODE, null, &sound.sound);
